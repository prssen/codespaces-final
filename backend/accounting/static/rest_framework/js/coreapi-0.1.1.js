                        ...
                        _createClass(SessionAuthentication, [
                            {
                                ...
                                value: function authenticate(options) {
                                    ...
                                    if (
                                        this.csrfToken &&
                                        !utils.csrfSafeMethod(options.method)
                                    ) {
                                        options.headers[this.csrfHeaderName] =
                                            this.csrfToken;
                                    }
                                    return options;
                                },
                ...
                function (require, module, exports) {
                    ...
                    function primitiveToNode(data, baseUrl) {
                        ...
                        if (isObject && data._type === "document") {
                            ...
                            var url = relativeUrl
                                ? URL(relativeUrl, baseUrl).toString()
                                : "";
                            ...
                            var fields = [];
                            for (
                                var idx = 0, len = fieldsData.length;
                                idx < len;
                                idx++
                            ) {
                                ...
                                var fieldDescription = getString(
                                    value,
                                    "fieldDescription"
                                );
                            ...
                            var _content2 = [];
                            for (
                                var _idx = 0, _len = data.length;
                                _idx < _len;
                                _idx++
                            ) {
                                _content2.push(
                                    primitiveToNode(data[_idx], baseUrl)
                                );
                            }
                            return _content2;
                        }
                        ...
                        function ErrorMessage(message, content) {
                            ...
                            var _this3 = _possibleConstructorReturn(
                                ...
                                (
                                    ...
                                    Object.getPrototypeOf(ErrorMessage)
                                ).call(this, message)
                            );
                ...
                function (require, module, exports) {
                    ...
                    var parseResponse = function parseResponse(
                        ...
                        return response.text().then(function (text) {
                            ...
                            var decoder = utils.negotiateDecoder(
                                decoders,
                                contentType
                            );
                        ...
                        _createClass(HTTPTransport, [
                            {
                                ...
                                value: function buildRequest(link, decoders) {
                                    ...
                                    for (
                                        ...
                                        if (
                                            !params.hasOwnProperty(field.name)
                                        ) {
                                            if (field.required) {
            ...
            15: [
                function (require, module, exports) {
                    ...
                    var determineTransport = function determineTransport(
                        ...
                        try {
                            for (
                                var _iterator = transports[Symbol.iterator](),
                                    _step;
                                !(_iteratorNormalCompletion = (_step =
                                    _iterator.next()).done);
                                _iteratorNormalCompletion = true
                    ...
                    var negotiateDecoder = function negotiateDecoder(
                        ...
                        try {
                            for (
                                var _iterator2 = decoders[Symbol.iterator](),
                                    _step2;
                                ...
                                if (
                                    acceptableTypes.includes(decoder.mediaType)
                                ) {
                                    return decoder;
                                }
                            }
                        ...
                        throw Error(
                            "Unsupported media in Content-Type header: " +
                                contentType
                        );
                    };
            ...
            21: [
                function (require, module, exports) {
                    (function (root, factory) {
                         ...
                         * @return {string}
                         */
                        UrlTemplate.prototype.encodeUnreserved = function (
                            str
                        ) {
                         ...
                         * @return {boolean}
                         */
                        UrlTemplate.prototype.isKeyOperator = function (
                            operator
                        ) {
                            return (
                                operator === ";" ||
