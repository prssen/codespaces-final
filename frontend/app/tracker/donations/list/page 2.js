...
const DonationHistory = () => {
    ...
    const donations = [
        {id: 1, date: '01/01/24', appeal: 'Nepal Emergency Relief', charity: 'Oxfam', amount: '£20.00'}
    ];
        ...
        <>
            <Container>
                ...
                <Grid container spacing={4}>
                    <Grid item xs={10}>
                        <Box sx={{display: 'flex', flexDirection: 'row', justifyContent: 'space-around', marginBottom: 4}}>
                            <Paper sx={{p: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
                                <Typography variant='h4' component='body1'>£150.00</Typography>
                                <Typography>Total Donations</Typography>
                            </Paper>
                            <Paper sx={{p: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
                                <Typography variant='h4' component='body1'>£120.00</Typography>
                                <Typography>Spent</Typography>
                            </Paper>
                        </Box>
                    </Grid>
                            <Grid item xs={9}>
                                <Typography variant='h4' mb={3}>Donation history</Typography>
                                {donations.map((donation) => (
                                    <Paper variant='outlined' padding={2}>
                                        <Box sx={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 2}}>
                                            <Box sx={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                                                ...
                                                /> */}
                                                <Typography mx={2}>{donation.date}</Typography>
                                                <Box>
                                                    <Typography variant='h6' component='body2'>{donation.appeal}</Typography>
                                                    <Typography variant='subtitle2'>{donation.charity}</Typography>
                                                </Box>
                                            </Box>
                                            <Box  sx={{display: 'flex', flexDirection: 'row', alignItems: 'center', gap: 2}}>
                                                <Typography variant='h5'>{donation.amount}</Typography>
