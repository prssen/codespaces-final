...
const CreateIndicatorForm = () => {
    ...
    const services = [
        { name: "Running day school", value: "day school" },
        { name: "Installing water pumps", value: "water pumps" },
    ];
            ...
            <Grid container spacing={2}>
                <Grid item xs={12}>
                    <Autocomplete
                        ...
                        onChange={(event, newValue) => {
                            const newEvent = { target: { name: "service" } };
                        ...
                        renderInput={(params) => (
                            <FormInput
                                {...params}
                                error={errors.fieldErrors?.service}
                                id="activity-service-input"
                                name="service"
                                label="Project Service"
                                helperText={
                                    errors.fieldErrors?.service?.join("; ") ||
                                    "Choose a service that this indicator measures"
                                }
                                inputProps={{
                                    ...params.inputProps,
                                }}
                ...
                <Grid item xs={12}>
                    <Autocomplete
                        ...
                        selectOnFocus
                        clearOnBlur
                        // Code from https://mui.com/material-ui/react-autocomplete/#creatable
                        ...
                        options={services.map((option) => option)}
                        // TODO: when closing and opening the options, the 'add {newValue}'
                        // disappears - correct
                        filterOptions={(options, params) => {
                            // Code adapted from https://mui.com/material-ui/react-autocomplete/#creatable
                            const filtered = filter(options, params);

                            const { inputValue } = params;
                            // If input value is not in the select options, then create an
                            // 'Add new {inputValue}' option
                        ...
                        renderInput={(params) => (
                            <FormInput
                                {...params}
                                error={errors.fieldErrors?.unit}
                                id="indicator-unit-input"
                                name="unit"
                                label="Indicator Unit"
                                helperText={
                                    errors.fieldErrors?.indicator?.join("; ") ||
                                    "Choose the unit that this indicator is measured in"
                                }
                                inputProps={{
                                    ...params.inputProps,
                                }}
                ...
                <Grid item xs={12}>
                    <FormInput
                        ...
                        helperText={
                            ...
                            "Add a description of the indicator"
                        }
                ...
                <Grid item xs={6}>
                    <FormInput
                        error={errors.fieldErrors?.targetQuantity}
                        id="indicator-targetQuantity"
                        name="targetQuantity"
                        label="Target amount"
                        type="number"
                        sx={{ mt: 3, width: "100%" }}
                        ...
                        helperText={
                            errors.fieldErrors?.amount?.join("; ") ||
                            "State the target value for this indicator, in the units you have chosen above"
                        }
                    ...
                    <FormControlLabel
                        control={
                            <Checkbox
                                ...
                                id="indicator-is-cumulative"
                                errors={errors.fieldErrors?.isCumulative}
                                helperText={
                                    errors.fieldErrors?.isCumulative?.join(
                                        "; "
                                    ) ||
                                    "Tick if indicator values can be added together to give a total - for example, 'Meals served'. Do not tick for percentages or rates"
                                }
                                name="isCumulative"
